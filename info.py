...
USERNAME = environ.get('USERNAME', "https://t.me/Im_professor_22") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037836704'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/clxxoxpxp')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', 'https://t.me/movie_update_channel0').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002037836704'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002037836704'))
auth_channel = environ.get('AUTH_CHANNEL', '')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002315275804'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', 'https://t.me/movie_update_channel0')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/backup_group130') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/howtoopin")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/howtoopin")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/howtoopin")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "fce81b379d2558448d16b9d483e1d406c80078a6")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'arlinks.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", "fce81b379d2558448d16b9d483e1d406c80078a6")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'arlinks.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "fce81b379d2558448d16b9d483e1d406c80078a6")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/zTl.jpg https://envs.sh/zTU.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/890a69b683722940661c1.jpg')).split()
