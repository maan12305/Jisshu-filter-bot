...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        btn = [[
            InlineKeyboardButton('🍁 Cʜᴇᴄᴋ Aʟʟ Pʟᴀɴꜱ & Pʀɪᴄᴇꜱ 🍁', callback_data='free')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 Sᴇɴᴅ Sᴄʀᴇᴇɴꜱʜᴏᴛ ☆', url=f'https://t.me/Im_professor_22')
        ],[
            InlineKeyboardButton('💎 Cᴜꜱᴛᴏᴍ Pʟᴀɴ 💎', callback_data='other')
        ],[
    ...
    #jisshu
       ...
       await query.message.edit_media(
        ...
        buttons = [[
            InlineKeyboardButton('☎️ Cᴏɴᴛᴀᴄᴛ Oᴡɴᴇʀ Tᴏ Kɴᴏᴡ Mᴏʀᴇ', user_id = ADMINS[0])
        ],[
      ...
      await client.edit_message_media(
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'http://telegram.dog/maam_movies_backup'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
...
if offset != "":
    btn.insert(0, [InlineKeyboardButton("🚩 Dɪʀᴇᴄᴛ Fɪʟᴇꜱ ? Nᴏ Vᴇʀɪғʏ", callback_data='seeplans')])
    ...
    if imdb:
        ...
        cap = f"<b>✪ {search} 𝙐𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝘽𝙮 ☟</b><b>\n@maam_movies_backup</b>\n<b>⚜ 𝙁𝙤𝙪𝙣𝙙𝙚𝙙 𝙍𝙚𝙨𝙪𝙡𝙩𝙨 𝙁𝙤𝙧 𝙔𝙤𝙪𝙧 𝙍𝙚𝙦𝙪𝙚𝙨𝙩 ❤️‍🔥</b>"
